...
<body>
	<p class="bg-primary text-white center">자유 게시판</p>
	<div class="my-3">
		<form action="${contextPath}/board/school/school/free/" method="get" class="form-inline searchForm">
		<select class="form-control mr-2 category">
			...
			<div class="form-group">
			 	<a href="${contextPath}/board/school/school/free" type="button" class="btn btn-primary">새로고침</a>
			</div>
		</form>
	</div>
	<table class="table">
		...
		<c:forEach items="${board}" var="b">
			<tr>
				...
				<td><a href="${contextPath}/board/detail/${b.sno}">
					${b.title}
					<c:if test="${b.clickcnt >0}">
				 		(${b.clickcnt})
					</c:if>
				 </a>
	...
	<a href="${contextPath}/board/freeWrite/${kind}/${pageName}">글 쓰기</a>
</body>
</html>