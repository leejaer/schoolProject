...
<body>
  <p class="bg-primary text-white center">행사</p>
	<div class="my-3">
		<form action="${contextPath}/board/school/school/event" method="get" class="form-inline searchForm">
			...
			<div class="form-group mr-2">
			 ...
			 <div class="form-group">
			 	<a href="${contextPath}/board/school/school/event" type="button" class="btn btn-primary">새로고침</a>
			 </div>
		</form>
	</div>
	<table class="table">
