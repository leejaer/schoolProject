...
<body>
	<p class="bg-primary text-white center">공지</p>
	<div class="my-3">
		<form action="${contextPath}/board/school/school/notice" method="get" class="form-inline searchForm">
			...
			<div class="form-group mr-2">
			 ...
			 <div class="form-group">
			 	<a href="${contextPath}/board/school/school/notice" type="button" class="btn btn-primary">새로고침</a>
			 </div>
		</form>
	</div>
	<table class="table">
