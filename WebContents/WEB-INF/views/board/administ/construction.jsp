...
<body>
	...
	<div class="my-3">
		<div class="form-group">
		 	<a href="${contextPath}/board/adminst/adminst/construction" type="button" class="btn btn-primary">새로고침</a>
		</div>
	</div>
	<table class="table">
			<tr>
	...
	<a href="${contextPath}/board/construction/adminst/${pageName}">입력</a>
</body>
</html>